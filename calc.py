...
button_add = tk.Button(window, text='+', bg='#444444', fg='#FFFFFF', font='Comfortaa 32', width=3, height=2,
                       command=add)
button_add.place(x=95, y=504)
button_sub = tk.Button(window, text='-', bg='#444444', fg='#FFFFFF', font='Comfortaa 32', width=3, height=2,
                       command=sub)
button_sub.place(x=200, y=504)
button_mul = tk.Button(window, text='*', bg='#444444', fg='#FFFFFF', font='Comfortaa 32', width=3, height=2,
                       command=mul)
button_mul.place(x=305, y=504)
button_div = tk.Button(window, text='/', bg='#444444', fg='#FFFFFF', font='Comfortaa 32', width=3, height=2,
                       command=div)
